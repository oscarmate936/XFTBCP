...
with st.sidebar:
    ...
    # Diccionario de copas con IDs CORREGIDOS y temporada sugerida
    copas = {
        "🏆 Champions League": {"id": 4480, "season_default": "2024-2025"},
        ...
        "🌍 Mundial de Clubes": {"id": 4488, "season_default": "2024"},
    }
